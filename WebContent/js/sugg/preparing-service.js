...
function updateUi(data,suggId){
	...
	var li_serv = ""
	li_serv += createHeader('행사 정보');
	li_serv += createBody('행사형식',data.SERV_TYPE_NAME);
	li_serv += createBody('진행형식',data.EVENT_TYPE_NAME);
...
function dataSubmit(){
	document.dForm.action = "/sugg/start-shipping.do";
