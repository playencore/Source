...
<c:forEach var="matchingFailAnswer" items="${matchingFailAnswer}">
	<!-- 섹션 타이틀 -->
							...
							<div class="row" id="sec_addr" style="margin-bottom: 0px;">
								<div class="col m9">
									<div class="input-field">
										...
										<input readonly="readonly"  id="addr" name="addr" type="text" class="validate" value="${matchingFailAnswer.address }">
			          			...
			          			<div class="col m9">
				          			<div class="input-field">
										<input id="addr2" name="addr2" type="text" class="validate" data-length="50" value="${matchingFailAnswer.address_detail}">
						...
						<div class="col m10">
							<div class="row" style="margin-bottom: 0px;">
								<div class="col m4" style="padding-right: 0px">
									<div class="input-field">
										<input id="serv_date" name="serv_date" type="text" class="datepicker" readonly="readonly" value="${matchingFailAnswer.serv_date }">
								...
								<div class="col m4" style="padding-right: 0px">
									<div class="input-field">
										<input id="serv_time" name="serv_time" type="text" class="timepicker" readonly="readonly" value="${matchingFailAnswer.serv_date }">
							...
							<div class="row" style="margin-bottom: 0px;">
								<div class="col m2" style="padding-right: 0px">
									<div class="input-field" style="margin-top:30px;margin-right:20px;">
										<input id="participant" type="number" class="validate" name="participant" value="${matchingFailAnswer.participant }">
								...
								<div class="col m3" style="padding-right: 10px;margin-right:20px;">
									<p>남성 비율</p>
								    <div id="percent"></div>
								    <input type="hidden" name="percent" value="${matchingFailAnswer.per_men }">
								</div>
								<div class="col m4">
									<p>참가자 연령(최소 ~ 최대)</p>
								    <div id="age"></div>
								    <input type="hidden" name="age_min" value="${matchingFailAnswer.age_min }">
								    <input type="hidden" name="age_max" value="${matchingFailAnswer.age_max }">
								</div>
							</div>
						</div>
					</div>
							...
							<div class="row" style="margin-bottom: 0px;">
								<div class="col m4" style="padding-right: 0px">
									<div class="input-field">
										...
										<input id="per_bud" name="per_bud" type="number" class="validate" onkeyup="updateAmount(this)" value="${matchingFailAnswer.per_bud }">
						...
						<div class="col m10">
							<div class="row" style="margin-bottom: 0px;">
								<div class="col m9" style="padding-right: 0px">
									<div class="input-field">
										<textarea id="req_term" name="req_term" class="materialize-textarea" cols="30" rows="10" data-length="300">${matchingFailAnswer.requested_term }</textarea>
