...
<script type="text/javascript" src="/js/sugg/preparing-service.js"></script>
		...
		<div class="col m12" style="background-color: white;">
			<div class="row">
				<div class="col m12" style="border: 1px solid #eeeeee">
		    		...
		    		<c:forEach items="${preparingList }" var="item">
			    		...
			    		<div class="col m6" style="border: 1px solid #eeeeee; margin-bottom: 20px;">
							<ul class="collection with-header">
								...
								<li class="collection-item dismissable">
									...
									<span class="secondary-content"><span > 서비스 준비중 </span></span>
								</li>
								<li class="collection-item dismissable">
								...
								<li class="collection-item dismissable">
									<span class="width-100" style="font-size: 14px">참가자수</span>
									<span  class="secondary-content"><span class="">${item.PARTICIPANT} 명</span></span>
								</li>
